...
uint8_t UUID128_CHR_TENSION[]     = {0xc1, 0x1a, 0xcb, 0xcd, 0xab, 0x5e, 0x42, 0x38, 0x90, 0x96, 0xff, 0xb2, 0x11, 0xcb, 0xbb, 0xe0};
...
BLECharacteristic tension_characteristic        = BLECharacteristic(UUID128_CHR_TENSION);

SemaphoreHandle_t xBLEWriteSemaphore  = xSemaphoreCreateBinary();
SemaphoreHandle_t xBLENotifySemaphore = xSemaphoreCreateBinary();
SemaphoreHandle_t xTensionSemaphore   = xSemaphoreCreateBinary();
SemaphoreHandle_t xCoolerSemaphore    = xSemaphoreCreateBinary();
SemaphoreHandle_t xHumidifySemaphore  = xSemaphoreCreateBinary();
...
TaskHandle_t TaskHandle_Humidify;
