...
void loop()
{
  //Serial.print("Loop#: ");Serial.println(++loop_nr);
...
////    #ifdef BAROMETER_BMP280
////    int16_t BLE_temperature = (int16_t)(100* bmp280.getTemperature());
////    if ( notifyTemperature(BLE_temperature) ){
////      Serial.print("Temperature Measurement updated to: "); Serial.println(BLE_temperature); 
////    }else{
////      Serial.println("ERROR: Notify not set in the CCCD or not connected!");
////    }
////    #elif TEMPHUM_DHT
////    float BLE_temperature = dht.readTemperature();
////    if (BLE_temperature > 18 && BLE_temperature < 30){
////    if (writeTemperature(BLE_temperature*100)){
////      Serial.print("DHT Temp value:\t\t ");Serial.print(BLE_temperature);Serial.println("C");
////      Serial.println("Temperature write successfull");
////    }else{
////      Serial.print("Temperature write failed. Value: ");Serial.print(BLE_temperature);Serial.println("C");
////    }
////    }
...
//    
////    #ifdef TEMPHUM_DHT
////    float BLE_humidity = dht.readHumidity();
////    if (BLE_humidity){
////    if (writeHumidity(BLE_humidity*100)){
////      Serial.print("DHT Humidity value:\t ");Serial.print(BLE_humidity);Serial.println(" %RH");
////      Serial.println("Humidity write successfull");
////    }else{
////      Serial.print("Humidity write failed. Value:");
////      Serial.print(BLE_humidity);Serial.println(" %RH");
////    }
////    }
